...
<body>
	<%@ include file="header.jsp"%>
				<h2 style="color: #6781d1; text-align: center;margin: 24px auto;">MODIFY THE PRODUCTS</h2>
<div class="add-product">
			<c:url var="editproducturl" value="/admin/edit/product/${ProductWillEdit.productid}"/>
            <form:form action="${editproducturl}" modelAttribute="editedProduct" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="productid">Product ID</label>
                    <form:input type="text" path="productid" value="${ProductWillEdit.productid}" id="productid" disabled="true"></form:input>
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <form:input type="text" path="diameter" id="diameter" value="${ProductWillEdit.diameter}"></form:input>
                </div>
                <form:errors path="diameter" cssClass="errorFiled" ></form:errors>
                <div class="form-group">
                    <label for="symbolbrand">Product Symbol Brand</label>
                    <form:input type="text" path="symbolbrand" id="symbolbrand" value="${ProductWillEdit.symbolbrand}" disabled="true"></form:input>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <form:input type="text" path="glass" value="${ProductWillEdit.glass}"></form:input>
                </div>
                <form:errors path="glass" cssClass="errorFiled" ></form:errors>
                <div class="form-group">
                    <label for="material">Product Material</label>
                    <form:input type="text" path="material" value="${ProductWillEdit.material}"></form:input>
                </div>
                <form:errors path="material" cssClass="errorFiled" ></form:errors>
                <div class="form-group">
                    <label for="original">Product Orginal</label>
                    <form:input type="text" path="original" value="${ProductWillEdit.original}"></form:input>
                </div>
                <form:errors path="material" cssClass="errorFiled" ></form:errors>
                <div class="form-group">
               ...
               <span class="errorFiled">${emptyImg}</span>
                <div class="form-group">
                    ...
                    <form:input type="text" path="oldprice" value="${ProductWillEdit.oldprice}"></form:input>
                </div>
                <form:errors path="oldprice" cssClass="errorFiled" ></form:errors>
                <div class="form-group">
                    <label for="discountpercent">Product Discount Percent</label>
                    <form:input type="text" path="discountpercent" value="${ProductWillEdit.discountpercent}"></form:input>
                </div>
                <form:errors path="discountpercent" cssClass="errorFiled" ></form:errors>
                <div class="form-group">
                    <label for="discountprice">Product Discount Price</label>
                    <form:input type="text" path="discountprice" value="${ProductWillEdit.discountpercent}" disabled="true"
                         ></form:input>
                </div>
                <input type="submit" value="EDIT PRODUCT" id="addproductbtn">
            </form:form>
        </div>
